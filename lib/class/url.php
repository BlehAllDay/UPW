...
Handles URLs. This can be used to generate new or validate existing URLs.
...
class URL
{
	...
	private ?string
		...
		$pass		= NULL,
		$path		= NULL,
		$query		= NULL,	// Part after the ?.
		$fragment	= NULL;	// Part after the #.

	// Constructor.
	// Pass an existing URL to modify, or pass nothing to create a new URL to
	// modify and use.
